...
const Testimonial = () => {
  ...
  <div className={`grid gap-8 justify-center ${testimonials.length === 1 ? 'grid-cols-1' : testimonials.length === 2 ? 'md:grid-cols-2' : 'md:grid-cols-2 lg:grid-cols-3'}`}>
